...
- **⭐ PRESS "RELEASE THIS VERSION" – APPLE APPROVED 1.1.0 ON 2026-08-20** – the release button in App Store Connect. Nothing else is left to do, by anyone.
  <sub>Now – before v1 goes live</sub>
...
- [ ] **⭐ PRESS "RELEASE THIS VERSION" – APPLE APPROVED 1.1.0 ON 2026-08-20**
      Needs: Thomas – the release button in App Store Connect. Nothing else is
           left to do, by anyone.
      Note: Claude can press it through the App Store Connect API instead, in
           seconds, if that is easier than the dashboard – but it puts an app in
           front of real people, so it waits for a yes rather than being assumed.

      **The state, read from Apple's API rather than the dashboard
      (2026-08-20):** version 1.1.0 `PENDING_DEVELOPER_RELEASE`, carrying
      **build 25**, releaseType `MANUAL`; review submission
      `b3cdc162-943c-4b6b-b36d-8bbafa37c07d` `COMPLETE`, submitted
      `2026-08-19T20:32Z`. So: approved, not live, and nothing is queued behind
      it.
      ...
      **Until the button is pressed, real users are still on build 12, frozen
      ...
      sections – has reached nobody outside TestFlight. That is three weeks of
      finished work sitting one click away.
      ...
      **After release, 1.2.0 stops being blocked:** App Store Connect would not
      let a 1.2.0 version record exist while 1.1.0 was in review. Build 26
      (1.2.0, drag-to-reorder) is already VALID on TestFlight.
...
- [x] **⭐ Ship share expiry + Stop sharing as part of 1.1.0 – APPROVED 2026-08-20**
      🚀 **Apple approved 1.1.0 (build 25) on 2026-08-20**, less than a day after
           it was submitted at 20:32 UTC on 2026-08-19, on Thomas's instruction
           after he tested build 25 on TestFlight. The version now sits at
           `PENDING_DEVELOPER_RELEASE`. **Release is MANUAL** – approval does not
           reach users; Thomas presses release, and until he does this is still
           shipped to nobody. Open item at the top of *Now*.
