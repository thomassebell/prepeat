...
- **Confirm the shortened recipe status copy against the frames** – the app deviates from the frames here and it was my call.
  <sub>Someday – not committed</sub>
- **⚠️ Finish deploying the share host (needs Thomas for two clicks)** – a Vercel project, then the DNS. Nothing else is blocking.
  <sub>Someday – not committed</sub>
...
- [ ] **⚠️ Finish deploying the share host (needs Thomas for two clicks)**
      Needs: Thomas – a Vercel project, then the DNS. Nothing else is blocking.
