...
- [x] **⭐ Ship share expiry + Stop sharing as part of 1.1.0 – SUBMITTED 2026-08-19**
      🚀 **1.1.0 is WAITING_FOR_REVIEW with build 25**, submitted 20:32 UTC on
           Thomas's instruction after he tested build 25 on TestFlight.
           **Release is MANUAL** – approval does not reach users; Thomas presses
           release. Last review took 13 days.
