...
- **Confirm the shortened recipe status copy against the frames** – the app deviates from the frames here and it was my call.
  <sub>Someday – not committed</sub>
- **Replace the interim preview card with Thomas's design** – a frame for the 1200&times;630 chat card.
  <sub>Someday – not committed</sub>
...
- [ ] **Replace the interim preview card with Thomas's design**
      Needs: Thomas – a frame for the 1200&times;630 chat card.
      ...
      Known constraints, all measured: titles run 6&ndash;72 characters (median
           19), the card renders about 236px wide in a chat so 26px of caption is
